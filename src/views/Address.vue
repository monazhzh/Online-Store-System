    ...
    <div>
      ...
      <modal :mdShow="isMdShow" @close="closeModal">
        ...
        <div slot="btnGroup">
            ...
            <a class="btn btn--m btn--red" href="javascript:;" @click="isMdShow=false">Cancel</a>
        </div>
      </modal>
      <modal :mdShow="isMdShow2" @close="isMdShow2=false">
        <p slot="message">
          At least need one address
        </p>
        <div slot="btnGroup">
            <a class="btn btn--m btn--red" href="javascript:;" @click="isMdShow2=false">OK</a>
        </div>
      </modal>
